		...
		while (number <= hostingMiner.getIssueMaxHops()) {
			try {
				...
				Issue issue = new Issue(izzue.getUser().getLogin(), izzue.getClosedAt(), izzue.getCreatedAt(),
						izzue.getNumber(), StatusType.valueOf(izzue.getState().toUpperCase()), izzue.getTitle(), izzue.getUpdatedAt(),
						izzue.getBody());
	...
	public List<Milestone> getAllMilestones() {
		...
		while (number <= hostingMiner.getMilestoneMaxHops()) {
			try {
				...
				Milestone mileDB = new Milestone(mile.getNumber(), StatusType.valueOf(mile.getState().toUpperCase()), mile.getTitle(),
